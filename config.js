...
// ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚══════╝╚═╝  ╚═╝╚═╝   ╚═══╝    ╚═╝     ╚═╝╚═════╝ 
// ═══════════════════════════════════════════════════════════════════════════
//                    SYED MD - BOT CONFIGURATION
// ═══════════════════════════════════════════════════════════════════════════

// ============================================
// 🔥 MISHU-MD MINI - COMPLETE SETTINGS
// 👑 Developer: ꜱʏᴇᴅ ᴀʙᴅᴜʟ ᴡᴀʜᴀʙ ʙᴜᴋʜᴀʀɪ
...
',
    ...
    // ── Channel Settings ──
    CHANNEL_JID: '120363426863283917@newsletter',
    
    CHANNEL_IDS: [
        '120363426863283917@newsletter'
    ],
     ...
     * @type {string}
     */
    BOT_NAME: process.env.BOT_NAME || '💕⃝🕊️ 𝑺𝒚𝒆𝒅 𝗠𝗗 𝗠𝗶𝗻𝗶 💕⃝🕊️',
     ...
     * @type {string}
     */
    BOT_FOOTER: process.env.BOT_FOOTER || '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ꜱʏᴇᴅ ᴀʙᴅᴜʟ ᴡᴀʜᴀʙ ʙᴜᴋʜᴀʀɪ',
     ...
     * @type {string}
     */
    CHANNEL_JID: process.env.CHANNEL_JID || '120363426863283917@newsletter',
     ...
     * @type {string}
     */
    IMAGE_PATH: process.env.IMAGE_PATH || 'https://i.ibb.co/WN7G5fv7/0a79e7b3e4c3.jpg',

    /**
     * @description WhatsApp channel link for updates
     * @type {string}
     */
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029VbD1rlH5Ui2NwN6idF2v',

    /**
     * @description WhatsApp group invite link
     * @type {string}
     */
    GROUP_LINK: process.env.GROUP_LINK || 'https://whatsapp.com/channel/0029VbD1rlH5Ui2NwN6idF2v',

    /**
     * @description Owner WhatsApp link
     * @type {string}
     */
    OWNER_LINK: process.env.OWNER_LINK || 'https://wa.me/923376539373',
